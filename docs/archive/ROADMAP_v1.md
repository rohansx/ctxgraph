# ctxgraph — Roadmap (v1, ARCHIVED)

> ⚠️ **DEPRECATED — DO NOT FOLLOW THIS PLAN.**
> This is the original 4-phase plan (2026-04-07), written before cross-domain benchmarking and the deep-research synthesis. The phase structure is replaced by an explicit 10-move plan plus a 12-week schedule targeting two HN launches.
>
> **Current authoritative roadmap: `../ROADMAP.md`**
> **Why this is preserved**: documents the original Phase 1–4 framing (Smart Extraction / Privacy + Cross-Domain / Agent Features / Polish + Launch), which still loosely maps to v0.3 / v0.4 / v0.5. Useful for "why was this scoped that way" archeology.
